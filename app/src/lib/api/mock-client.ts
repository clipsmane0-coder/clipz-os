...
// CLIPZ — API Client
// ============================================================
// Auto-selects mock or real API based on VITE_API_MODE.
// Components and hooks do not know which mode is active.
// ============================================================

import { apiConfig } from "./config";

// Export everything from the mock client as the default
export * from "./mock-client";

// When real mode is active, override exports with the live client
if (apiConfig.isReal) {
  // Dynamic import ensures the mock client is always available as fallback
