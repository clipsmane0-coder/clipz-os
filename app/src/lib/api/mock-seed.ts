...
const candidateBase = {
  analysis_run_id: "a1b2c3d4-analysis",
  safety_status: "safe",
...
export const jobs: Job[] = [
  { id: "j1-render-1a2b", job_type: "render_clip", entity_type: "candidate", entity_id: candidates[0].id, profile_id: profiles[0].id, priority: "high", status: "running", progress_percent: 67, attempts: 1, max_attempts: 3, retryable: true, locked_by: "worker-01", locked_at: iso(0, -0.3), started_at: iso(0, -0.5), completed_at: null, error_code: null, error_message: null, payload_json: { render_preset: "tiktok_vertical" }, result_json: null, created_at: iso(0, -1), updated_at: iso(0, -0.2), entity_title: candidates[0].title, profile_name: profiles[0].name, render_device: "GPU (RTX 4080)", render_preset: "TikTok Vertical", estimated_time: "2m 14s", output_size: null },
  { id: "j2-render-3c4d", job_type: "render_clip", entity_type: "candidate", entity_id: candidates[4].id, profile_id: profiles[0].id, priority: "normal", status: "running", progress_percent: 34, attempts: 1, max_attempts: 3, retryable: true, locked_by: "worker-02", locked_at: iso(0, -0.1), started_at: iso(0, -0.3), completed_at: null, error_code: null, error_message: null, payload_json: { render_preset: "tiktok_vertical" }, result_json: null, created_at: iso(0, -0.7), updated_at: iso(0, -0.1), entity_title: candidates[4].title, profile_name: profiles[0].name, render_device: "GPU (RTX 4080)", render_preset: "Instagram Reel", estimated_time: "5m 30s", output_size: null },
  { id: "j3-render-5e6f", job_type: "render_clip", entity_type: "candidate", entity_id: candidates[6].id, profile_id: profiles[2].id, priority: "low", status: "queued", progress_percent: 0, attempts: 0, max_attempts: 3, retryable: true, locked_by: null, locked_at: null, started_at: null, completed_at: null, error_code: null, error_message: null, payload_json: { render_preset: "youtube_shorts" }, result_json: null, created_at: iso(0, -0.1), updated_at: iso(0, -0.1), entity_title: candidates[6].title, profile_name: profiles[2].name, render_device: "CPU", render_preset: "YouTube Shorts", estimated_time: "8m 10s", output_size: null },
