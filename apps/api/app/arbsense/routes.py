...
from .multipack_catalog import (
    get_catalog as multipack_get_catalog,
    get_categories as multipack_get_categories,
    get_by_id as multipack_get_by_id,
)
from .engine import (
    analyze_all_configs,
    generate_listing,
...
CURATED_OPPORTUNITIES = [
    ...
    {
        "id": "ARB-016",
        "product": "iPad 10.9-inch (10th Gen) WiFi 64GB",
        "brand": "Apple",
        "category": "Electronics / Tablets",
        "source_price": 349.00,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B0BJF547GQ",
        "source_status": "unverified",
        "ebay_price": 449.00,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=iPad+10th+Gen+64GB+WiFi+New",
        "ebay_listings_est": 200,
        "multipack_status": "single_product",
        "unit_description": "1 iPad in retail box",
        "strategy": "Buy on Amazon sale/back-to-school, resell on eBay. Apple products have enormous demand.",
        "demand_level": "very high",
        "notes": "Massive eBay market for iPads. Price spread opens up during sales (Prime Day, back-to-school, holiday). High velocity.",
    },
    {
        "id": "ARB-017",
        ...
        "source_price": 179.00,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B0CQWRPS73",
        "source_status": "unverified",
        "ebay_price": 229.00,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=AirPods+Pro+2nd+Gen+USB-C+New",
        "ebay_listings_est": 300,
        "multipack_status": "single_product",
        "unit_description": "1 pair AirPods Pro in retail box",
        "strategy": "Buy on Amazon sale, resell on eBay. Highest-volume Apple accessory.",
        "demand_level": "very high",
        "notes": "Probably the single highest-velocity consumer electronics product. Regularly drops to $179-199 on Amazon. eBay holds $219-249. Small, lightweight, fast sell.",
    },
    {
        "id": "ARB-018",
        "product": "Meta Quest 3 128GB VR Headset",
        "brand": "Meta",
        "category": "Electronics / VR",
        "source_price": 399.00,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B0CGJPKJPL",
        "source_status": "unverified",
        "ebay_price": 499.99,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=Meta+Quest+3+128GB+VR+Headset+New",
        "ebay_listings_est": 80,
        "multipack_status": "single_product",
        "unit_description": "1 VR headset in retail box",
        "strategy": "Buy on Amazon sale/Prime Day, resell at retail on eBay. In-demand VR hardware.",
        "demand_level": "high",
        "notes": "Premium VR with strong demand. Drops to $399 during major sales. Good price spread. Verify model number.",
    },
    {
        "id": "ARB-019",
        ...
        "source_price": 199.00,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B0CWHNLKRJ",
        "source_status": "unverified",
        "ebay_price": 279.00,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=Apple+Watch+SE+2nd+Gen+40mm+GPS+New",
        "ebay_listings_est": 180,
        "multipack_status": "single_product",
        "unit_description": "1 Apple Watch in retail box",
        "strategy": "Buy on Amazon sale, resell on eBay. Apple Watch has massive resale market.",
        "demand_level": "very high",
        "notes": "Regularly discounted to $199-219 on Amazon. eBay retail $249-279. High volume, fast turnover. Always in demand.",
    },
    {
        "id": "ARB-020",
        "product": "Shark Navigator Lift-Away Vacuum UV725",
        "brand": "Shark",
        "category": "Home / Appliances",
        "source_price": 119.99,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B07D6L4WQ2",
        "source_status": "unverified",
        "ebay_price": 199.99,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=Shark+Navigator+Lift+Away+UV725+New",
        "ebay_listings_est": 35,
        "multipack_status": "single_product",
        "unit_description": "1 vacuum in retail box",
        "strategy": "Buy on Amazon sale/clearance, resell on eBay at retail price. Shark is a popular mid-tier vacuum brand.",
        "demand_level": "medium-high",
        "notes": "Frequently drops to $119-139. Retail $179-199. Bulky but people pay for name brand. Verify model number — many variations.",
    },
    {
        "id": "ARB-021",
        "product": "Keurig K-Classic K55 Coffee Maker",
        "brand": "Keurig",
        "category": "Kitchen / Appliances",
        "source_price": 59.99,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B00MX978A8",
        "source_status": "unverified",
        "ebay_price": 119.99,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=Keurig+K+Classic+K55+Coffee+Maker+New",
        "ebay_listings_est": 50,
        "multipack_status": "single_product",
        "unit_description": "1 coffee maker in retail box",
        "strategy": "Buy on Amazon sale/clearance, resell on eBay. Keurig is a well-known brand with consistent demand.",
        "demand_level": "high",
        "notes": "Frequently on deep discount ($59-79). Retail is $119-149. Moderate size/weight. High demand kitchen appliance.",
    },
    {
        "id": "ARB-022",
        "product": "Garmin Forerunner 55 GPS Watch",
        "brand": "Garmin",
        "category": "Electronics / Wearables",
        "source_price": 149.99,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B099FHYT7N",
        "source_status": "unverified",
        "ebay_price": 199.99,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=Garmin+Forerunner+55+GPS+Watch+New",
        "ebay_listings_est": 45,
        "multipack_status": "single_product",
        "unit_description": "1 GPS watch in retail box",
        "strategy": "Buy on Amazon sale, resell on eBay. Garmin is a premium fitness brand with dedicated audience.",
        "demand_level": "medium-high",
        "notes": "Regularly drops to $149-169. Retail $199-229. Small, lightweight. Dedicated Garmin customer base.",
    },
    {
        "id": "ARB-023",
        "product": "GoPro HERO12 Black Action Camera",
        "brand": "GoPro",
        "category": "Electronics / Cameras",
        "source_price": 299.00,
        "source_size": 1,
        "source_url": "https://www.amazon.com/dp/B0CGVDL2Y8",
        "source_status": "unverified",
        "ebay_price": 379.99,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=GoPro+HERO12+Black+Action+Camera+New",
        "ebay_listings_est": 70,
        "multipack_status": "single_product",
        "unit_description": "1 camera in retail box",
        "strategy": "Buy on Amazon sale/holiday deal, resell at retail on eBay. GoPro is the dominant action cam brand.",
        "demand_level": "high",
        "notes": "GoPro has major sales during holidays ($299-329 vs $399 retail). Strong brand, good demand. Small, easy to ship.",
    },
    {
        "id": "ARB-024",
        "product": "Philips Sonicare 4100 Electric Toothbrush 2-pack",
        "brand": "Philips Sonicare",
        "category": "Oral Care / Personal Care",
        "source_price": 49.99,
        "source_size": 2,
        "source_url": "https://www.amazon.com/dp/B08L8F12S3",
        "source_status": "unverified",
        "ebay_price": 89.99,
        "ebay_search_url": "https://www.ebay.com/sch/i.html?_nkw=Philips+Sonicare+4100+Electric+Toothbrush+2+Pack",
        "ebay_listings_est": 40,
        "multipack_status": "true_multipack",
        "unit_description": "2 individually packaged electric toothbrushes in 2-pack box",
        "strategy": "Buy 2-pack on Amazon sale, split into individual toothbrushes for higher total resale on eBay. Each unit is independently packaged.",
        "demand_level": "high",
        "notes": "TRUE MULTIPACK — each toothbrush individually boxed inside the 2-pack. Can sell singles or 2-pack. Sonicare is premium brand. Small, lightweight shipping.",
    },
]
...
@router.get("/catalog")
async def api_multipack_catalog(
    category: Optional[str] = None,
    min_pack_size: int = 2,
    confidence: Optional[str] = None,
    min_est_profit: float = 0,
    sort_by: str = "est_profit",
    page: int = 1,
    per_page: int = 50,
):
    """
    Curated multipack product catalog.
    Each product has direct Temu/Amazon/eBay search links for manual verification.
    All prices are ESTIMATES — verify manually before action.
    """
    try:
        results = multipack_get_catalog(
            category=category,
            min_pack_size=min_pack_size,
            confidence=confidence,
            min_estimated_profit=min_est_profit,
            sort_by=sort_by,
        )
        ...
        categories = multipack_get_categories()
        ...
        return {
            ...
            "categories": categories,
            "products": paginated,
            "disclaimer": "All prices are estimated. Verify manually via the links provided.",
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def api_catalog_detail(product_id: str):
    """Get a single catalog entry with all links and estimated profit breakdown."""
    try:
        product = multipack_get_by_id(product_id)
        if not product:
...
async def api_catalog_categories():
    """List all categories available in the catalog."""
    return {"success": True, "categories": multipack_get_categories()}
